...
class MoovEZVisionAnalyzerV5:
    ...
    def __init__(self):
        ...
        print(f"✅ Gemini Vision Analyzer V5 initialized with model: gemini-2.0-flash-exp")
...
"""
    ...
    def analyze_multiple_images(self, image_paths):
        ...
        for idx, image_path in enumerate(image_paths, 1):
            ...
            items_data, analysis_time = self.analyze_image(image_path)
            
            if items_data:  # If analysis was successful
    ...
    def display_metrics(self):
        ...
        print("\n" + "="*80)
        print("⏱️ PERFORMANCE METRICS (V5 - Gemini)")
        print("="*80)
        ...
        print(f"Gemini API Calls: {self.metrics.get('api_calls', 1)} (for item identification only)")
...
def main():
    ...
    if result:
        ...
        output_file = "moving_analysis_result_v5.json"
