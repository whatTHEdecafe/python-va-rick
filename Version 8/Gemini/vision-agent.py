"""
MoovEZ Vision Analyzer V6 - Modular Architecture
Refactored with abstraction, inheritance, and polymorphism for better maintainability

This version maintains full compatibility with the UI App while providing:
...
class MoovEZVisionAnalyzerV6:
            ...
            for image_path in image_files:
                ...
                try:
                    ...
                    if hasattr(handler, 'get_uploadable_path'):
                        upload_path, is_temp = handler.get_uploadable_path(image_path)
                        if is_temp:
    ...
    def calculate_moving_logistics(self, items_data: Dict[str, Any], 
                                  pickup_access: Dict[str, Any], 
                                  dropoff_access: Dict[str, Any], 
                                  travel_time: int = 30,
                                  pre_move_travel: int = 30) -> Optional[Dict[str, Any]]:
        """
        Calculate moving logistics using the calculator module
        
        Args:
            items_data: Detected items from AI analysis
            pickup_access: Pickup location details
            dropoff_access: Dropoff location details
            travel_time: Travel time between locations in minutes
            
        Returns:
            Complete logistics calculation results
        """
    ...
    def process_moving_request(self, file_paths: Union[str, List[str]], 
        ...
        # Step 1: Analyze files (AI vision)
        ...
        # Step 2: Calculate logistics
        calculations = self.calculate_moving_logistics(items_data, pickup_access, dropoff_access, travel_time, pre_move_travel)
        if not calculations:
        ...
        return {
            ...
            "features": ["image_support", "video_support", "multi_file_upload", "modular_architecture"]
        }


# Maintain backward compatibility alias
MoovEZVisionAnalyzerV5 = MoovEZVisionAnalyzerV6
